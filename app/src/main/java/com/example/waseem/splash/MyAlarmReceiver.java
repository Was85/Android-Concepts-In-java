...
public class MyAlarmReceiver extends BroadcastReceiver {
    ...
    public void onReceive(final Context context, Intent intent) {
       ...
       // String [] popUpArray =intent.getStringArrayExtra("popUpText");
        ...
        Gson gson = new Gson();
        String jsonText = sp.getString("selectedPopUp", null);
        if(jsonText != null){
            String[] popUpArray = gson.fromJson(jsonText, String[].class);

            Intent i = new Intent(context, MyTestService.class);


            i.putExtra("popUpText", popUpArray);

            Toast.makeText(context, " alarm class here ", Toast.LENGTH_SHORT).show();

            context.startService(i);
        }else Toast.makeText(context, "Null json ", Toast.LENGTH_SHORT).show();
